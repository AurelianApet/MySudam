...
// Initialing the mooSocial phrases for javascript functions
    ...
    public function loadRequireJs(){ 
        ...
        $v->Helpers->MooRequirejs->addPath(array(
            ...
            "mooResponsive"=>$v->Helpers->MooRequirejs->assetUrlJS("js/responsive.js"),
            ...
            "mooFileUploader"=>$v->Helpers->MooRequirejs->assetUrlJS("js/jquery.fileuploader.js"),
            ...
            "mooUser"=>$v->Helpers->MooRequirejs->assetUrlJS("js/moocore/user.js"),
            ...
            "mooBlog"=>$v->Helpers->MooRequirejs->assetUrlJS("js/moocore/plugins/blog.js"),
