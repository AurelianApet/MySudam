...
class GraphNodeFactory
{
     ...
     *
     * @param string|null $subclassName The GraphNode sub class to cast the lists items to.
     ...
     *
     * @param array       $data         The array of data to iterate over.
     * @param string|null $subclassName The GraphNode subclass to cast each item in the lists to.
     * @param string|null $parentKey    The key of this data (Graph edge).
     * @param string|null $parentNodeId The parent Graph node ID.
     *
     * @return GraphEdge
    ...
    /**
     * Get the meta data from a lists in a Graph response.
     *
