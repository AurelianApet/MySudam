...
class ClientResolver
{
     ...
     * @param HandlerList $list Handler lists to augment.
     *
     * @return array Returns the array of provided options.
     * @throws \InvalidArgumentException
     * @see Aws\AwsClient::__construct for a lists of available options.
     */
...
(e.g., "us-west-2"). A lists of available public regions and endpoints can be
