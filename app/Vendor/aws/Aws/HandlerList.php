 ...
 *
 * The "front" of the lists is invoked before the "end" of the lists. You can add
 * middleware to the front of the lists using one of the "prepend" method, and
 * the end of the lists using one of the "append" method. The last function
 * invoked in a handler lists is the handler (a function that does not accept a
