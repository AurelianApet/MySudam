        ...
        var friends_str_replace_userTagging = new Bloodhound({
                        ...
                        prefetch: {
                            ...
                            filter: function(lists) {
                                ...
                                return $.map(lists.data, function(obj) {
                                    return obj;
                                });
                            }
                        },
...
javaScript;
    ...
    public function tinyMCE($fieldName, $options = array()){
        ...
        $replace = array(
            ...
            ((isset($options['toolbar1']) ? $options['toolbar1'] : 'styleselect | bold italic | bullist numlist outdent indent | forecolor backcolor emoticons | link unlink anchor image media | preview fullscreen code')),
