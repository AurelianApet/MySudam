            ...
            <div class="mo_breadcrumb">
                ...
                <?php if ( !empty( $uid ) && Configure::read('core.feed_selection') ): ?>
                    <ul class="list7 header-list" id="feed-type">
                        <li><a href="<?php echo $this->request->base?>/activities/ajax_browse/everyone" <?php if ( isset($activity_feed) && $activity_feed == 'everyone' ) echo 'class="current"'; ?>>
                        <?php echo __('Everyone')?></a></li>
                        <li><a href="<?php echo $this->request->base?>/activities/ajax_browse/friends" <?php if ( isset($activity_feed) && $activity_feed == 'friends' ) echo 'class="current"'; ?>>
                        <?php echo __('Friends & Me')?></a></li>
                    </ul>
                <?php endif; ?>
            </div>
-->
