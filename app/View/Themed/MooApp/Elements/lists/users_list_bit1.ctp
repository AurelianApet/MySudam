...
<?php
        ...
        {
?>
            <td id="follow_<?php echo $userid; ?>"><a style="cursor:pointer;" onclick="set_follow(<?php echo $uid; ?>, <?php echo $userid; ?>)">
            <img src='<?php echo $this->webroot; ?>img/follow1.png' width='40px;' /></a></td>
<?php
        }
        else:
        {
?>
            <td id="follow_<?php echo $userid; ?>"><a style="cursor:pointer;" onclick="set_follow(<?php echo $uid; ?>, <?php echo $userid; ?>)">
            <img src='<?php echo $this->webroot; ?>img/follow.png' width='40px;' /></a></td>
<?php
        }
        endif;
?>
