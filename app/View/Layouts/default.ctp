...
<?php endif; ?>
    <div class="container-fluid">
        <?php if($this->getPageId() != 'page_blogs-create'): ?>
            ...
            <?php endif; ?>
        <?php else: ?>
            <div id="btnPrev" style="display:none;float:left;width:50px;height:30px;background:#1C659B;position:relative;border-radius:4px;padding:5px; margin-top:9px;" onclick="onbtnPrev();">
                <label style="font-size: 14px; color:white;"><?php echo __('이전'); ?></label>
            </div>
            <label style="float:center; font-size: 18px; padding:10px; color:white;"><?php echo __('글 작성'); ?></label>
            <div id="btnNext" style="display:none;float:right;width:50px;height:30px;background:#1C659B;position:relative;border-radius:4px;padding:5px; margin-top:9px;" onclick="onbtnNext();">
                <label style="font-size: 14px; color:white;"><?php echo __('다음'); ?></label>
            </div>
        <?php endif; ?>
    </div>
</div>
