...
class Blog extends BlogAppModel {
    ...
    {
        $blogs = $this->find('all', array('conditions' => array('Blog.user_id' => $id)));
        return count($blogs);
    }
	/*
	 ...
	 * @return array $blogs
	 */
	public function getBlogs( $type = null, $param = null, $page = 1, $limit = PROFILE_BLOG_LIMIT, $friend_list = '',$role_id = null)
	{
            $cond = array();
