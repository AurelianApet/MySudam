...
<?php $this->start('west'); ?>
	<div class="box2 filter_block">
		...
		<ul class="list2 menu-list" id="browse">
			<li class="current" id="browse_all"><a class="json-view" data-url="<?php echo $this->request->base?>/blogs/browse/all" href="<?php echo $this->request->base?>/blogs">
			<?php echo __( 'All Entries')?></a></li>
			<?php if (!empty($uid)): ?>
