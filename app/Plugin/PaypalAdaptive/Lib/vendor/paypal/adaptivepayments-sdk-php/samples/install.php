...
function init($useComposer) {
	...
	if($useComposer) {
		...
		//array $processsed contains lists of dependencies that have already been downloaded
		$processed = array();
 ...
 * @param array $processed contains lists of directories already scanned for dependency
 */
