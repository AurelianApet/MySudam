...
class CommentsController extends ApiAppController {
    ...
    protected function _sendNotifications($data) {
        ...
        $users = $this->Comment->find('lists', array('conditions' => array('Comment.target_id' => $data['target_id'],
            ...
            if ($this->Comment->save($this->request->data)) {
                ...
                switch ($type) {
                    case APP_CONVERSATION:
                        ...
                        $participants = $this->ConversationUser->find('lists', array('conditions' => array('conversation_id' => $this->request->data['target_id'],
