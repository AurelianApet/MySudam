 ...
 *
 * @param array $named A lists of named parameters. Key value pairs are accepted where values are
...
/**
 * Returns the lists of prefixes used in connected routes
 *
 * @return array A lists of prefixes used in connected routes
 */
