...
/**
 * Holds the lists of behavior names that were attached when this object was created
 *
 * @var array
 */
...
/**
 * Processes the passed fieldList and returns the lists of fields to be validated
 *
 * @param array $fieldList lists of fields to be used for validation
 ...
 * CakeValidationSet then rules lists for the field will be replaced with second argument and
 ...
 * @param string|array|CakeValidationSet $name name of the rule to be added or lists of rules for the field
 * @param array|CakeValidationRule $rule or lists of rules to be added to the field's rule set
 * @return self
 */
