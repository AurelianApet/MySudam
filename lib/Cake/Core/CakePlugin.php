...
/**
 * Holds a lists of all loaded plugins and their configuration
 *
 * @var array
 */
 ...
 * to use.
 *
 * @param array $options Options lists. See CakePlugin::load() for valid options.
 * @return void
 */
 ...
 * If plugin is null, it will return a lists of all loaded plugins
 *
 * @param string $plugin Plugin name to check.
 * @return mixed boolean true if $plugin is already loaded.
 * If $plugin is null, returns a lists of plugins that have been loaded
 */
