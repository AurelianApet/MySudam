 ...
 *
 * @param array $paths associative array with package names as keys and a lists of directories for new search paths
 ...
 * @param string $name unique name of the file for identifying it inside the application
 * @param string $plugin camel cased plugin name if any
 * @param array $search lists of paths to search the file into
