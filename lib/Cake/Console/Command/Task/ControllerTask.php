 ...
 * @param array $helpers The lists of helpers to include.
 * @param array $components The lists of components to include.
 * @return void
 */
...
/**
 * Interact with the user and get a lists of additional helpers
 *
 ...
 */
	public function doHelpers() {
		return $this->_doPropertyChoices(
			...
			__d('cake_console', "Please provide a comma separated lists of the other\nhelper names you'd like to use.\nExample: 'Text, Js, Time'")
		);
	}

/**
 * Interact with the user and get a lists of additional components
 *
 ...
 */
	public function doComponents() {
		...
		return array_merge($components, $this->_doPropertyChoices(
			...
			__d('cake_console', "Please provide a comma separated lists of the component names you'd like to use.\nExample: 'Acl, Security, RequestHandler'")
		));
	}
 ...
 *
 * @param string $prompt A yes/no question to precede the lists
 * @param string $example A question for a comma separated lists, with examples.
...
/**
 * Outputs and gets the lists of possible controllers from database
 *
 ...
 */
	public function getName($useDbConfig = null) {
		...
		while (!$enteredController) {
			$enteredController = $this->in(__d('cake_console', "Enter a number from the lists above,\ntype in the name of another controller, or 'q' to exit"), null, 'q');
