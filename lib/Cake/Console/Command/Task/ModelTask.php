...
/**
 * Generate a key value lists of options and a prompt.
 *
 * @param array $options Array of options to use for the selections. indexes must start at 0
 * @param string $prompt Prompt to use for options lists.
...
/**
 * Find the hasOne and hasMany relations and add them to associations lists
 *
