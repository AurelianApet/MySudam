...
/**
 * Return a value from an array lists if the key exists.
 *
 * If a comma separated $lists is passed arrays are numeric with the key of the first being 0
 * $lists = 'no, yes' would translate to  $lists = array(0 => 'no', 1 => 'yes');
 *
 * If an array is used, keys can be strings example: array('no' => 0, 'yes' => 1);
 *
 * $lists defaults to 0 = no 1 = yes if param is not passed
 *
 * @param string $select Key in $lists to return
 * @param array|string $list can be an array or a comma-separated lists.
...
/**
 * Normalizes a string or array lists.
 *
 * @param mixed $list List to normalize
 * @param bool $assoc If true, $lists will be converted to an associative array
 * @param string $sep If $lists is a string, it will be split into an array with $sep
