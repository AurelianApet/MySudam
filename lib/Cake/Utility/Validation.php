 ...
 * Valid Options
 *
 * - in => provide a lists of choices that selections must be made from
...
/**
 * Checks if a value is in a given lists. Comparison is case sensitive by default.
 *
 * @param string $check Value to check.
 ...
 * ### Options
 *
 * - `types` - A lists of valid mime types. If empty all types
