 ...
 *
 * The $key parameter accepts the following lists of values:
 *
 * - key: Returns the name of the primary key for the model
 * - fields: Returns the model schema
 * - validates: returns the lists of fields that are required
 * - errors: returns the lists of validation errors
 *
...
/**
 * Add to or get the lists of fields that are currently unlocked.
 * Unlocked fields are not included in the field hash used by SecurityComponent
 * unlocking a field once its been added to the lists of secured fields will remove
 * it from the lists of fields.
 *
 * @param string $name The dot separated name for the field.
 * @return mixed Either null, or the lists of fields.
...
/**
 * Generates lists of options for multiple select
 *
