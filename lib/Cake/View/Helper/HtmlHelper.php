...
/**
 * Returns breadcrumbs as a (x)html lists
 *
 * This method uses HtmlHelper::tag() to generate lists and its elements. Works
 ...
 *
 * @param array $options Array of html attributes to apply to the generated lists elements.
 * @param string|array|bool $startText This will be the first crumb, if false it defaults to first crumb in array. Can
 *   also be an array, see `HtmlHelper::getCrumbs` for details.
 * @return string|null breadcrumbs html lists
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/html.html#creating-breadcrumb-trails-with-htmlhelper
 */
 ...
 * @return array Crumb lists including startText (if provided)
 */
...
/**
 * Build a nested lists (UL/OL) out of an associative array.
 *
 * @param array $list Set of elements to lists
 * @param array $options Additional HTML attributes of the lists (ol/ul) tag or if ul/ol use that as tag
 * @param array $itemOptions Additional HTML attributes of the lists item (LI) tag
 * @param string $tag Type of lists tag to use (ol/ul)
...
/**
 * Internal function to build a nested lists (UL/OL) out of an associative array.
 *
 * @param array $items Set of elements to lists
 * @param array $options Additional HTML attributes of the lists (ol/ul) tag
 * @param array $itemOptions Additional HTML attributes of the lists item (LI) tag
 * @param string $tag Type of lists tag to use (ol/ul)
 * @return string The nested lists element
