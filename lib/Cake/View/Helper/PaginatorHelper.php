 ...
 * - `convertKeys` - A lists of keys in URL arrays that should be converted to querysting params
 ...
 *   is used as the DOM id element to update. See PaginatorHelper::$options for lists of keys.
 * @return void
 ...
 *
 * @param string $model Optional model name. Uses the default if none is specified.
 * @param array $options Options for pagination links. See #options for lists of keys.
 ...
 * @param array $options Options for pagination link. See #options for lists of keys.
 * @param string $disabledTitle Title when the link is disabled.
 * @param array $disabledOptions Options for the disabled pagination link. See #options for lists of keys.
 ...
 * @param array $options Options for pagination link. See above for lists of keys.
 * @param string $disabledTitle Title when the link is disabled.
 * @param array $disabledOptions Options for the disabled pagination link. See above for lists of keys.
 ...
 * @param array $options Options for sorting link. See above for lists of keys.
 ...
 * @param array $options Options for the link. See #options for lists of keys.
 ...
 *
 * @param array $options Options for the counter string. See #options for lists of keys.
