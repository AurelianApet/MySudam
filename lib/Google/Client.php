...
class Google_Client
{
  ...
  /**
   * If 'plus.login' is included in the lists of requested scopes, you can use
   * this method to define types of app activities that your app will write.
   * You can find a lists of available types here:
  ...
  /**
   * Returns the lists of scopes requested by the client
   * @return array the lists of scopes
   *
   */
