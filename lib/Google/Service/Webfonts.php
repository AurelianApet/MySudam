...
class Google_Service_Webfonts_Webfonts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves the lists of fonts currently served by the Google Fonts Developer
   * API (webfonts.listWebfonts)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string sort Enables sorting of the lists
  ...
  public function listWebfonts($optParams = array())
  {
    ...
    return $this->call('lists', array($params), "Google_Service_Webfonts_WebfontList");
  }
}
