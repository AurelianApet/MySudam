...
class Google_Service_PlusDomains extends Google_Service
{
  ...
  /** Know your basic profile info and lists of people in your circles.. */
  const PLUS_LOGIN =
...
class Google_Service_PlusDomains_Activities_Resource extends Google_Service_Resource
{
   ...
   * @param string $collection The collection of activities to lists.
   * @param array $optParams Optional parameters.
   *
  ...
  public function listActivities($userId, $collection, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_PlusDomains_ActivityFeed");
  }
}
...
class Google_Service_PlusDomains_Audiences_Resource extends Google_Service_Resource
{
  ...
  public function listAudiences($userId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_PlusDomains_AudiencesFeed");
  }
}
...
class Google_Service_PlusDomains_Circles_Resource extends Google_Service_Resource
{
  ...
  public function listCircles($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_PlusDomains_CircleFeed");
  }
...
class Google_Service_PlusDomains_Comments_Resource extends Google_Service_Resource
{
   ...
   * through large result sets. To get the next page of results, set this
   * parameter to the value of "nextPageToken" from the previous response.
   * @opt_param string sortOrder The order in which to sort the lists of comments.
  ...
  public function listComments($activityId, $optParams = array())
  {
    $params = array('activityId' => $activityId);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_PlusDomains_CommentFeed");
  }
}
...
class Google_Service_PlusDomains_People_Resource extends Google_Service_Resource
{
   ...
   * @param string $collection The collection of people to lists.
   * @param array $optParams Optional parameters.
   *
  ...
  public function listPeople($userId, $collection, $optParams = array())
  {
    $params = array('userId' => $userId, 'collection' => $collection);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_PlusDomains_PeopleFeed");
  }
   ...
   *
   * @param string $activityId The ID of the activity to get the lists of people
   * for.
   * @param string $collection The collection of people to lists.
   * @param array $optParams Optional parameters.
   *
