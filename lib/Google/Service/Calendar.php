...
class Google_Service_Calendar_Acl_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns the rules in the access control lists for the calendar. (acl.listAcl)
   *
   * @param string $calendarId Calendar identifier.
   * @param array $optParams Optional parameters.
   *
   ...
   * returned on the last page of results from the previous lists request. It makes
   * the result of this lists request contain only entries that have changed since
   * then. All entries deleted since the previous lists request will always be in
  ...
  public function listAcl($calendarId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Calendar_Acl");
  }
...
class Google_Service_Calendar_CalendarList_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes an entry on the user's calendar lists. (calendarList.delete)
   *
   * @param string $calendarId Calendar identifier.
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Returns an entry on the user's calendar lists. (calendarList.get)
   *
   * @param string $calendarId Calendar identifier.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Adds an entry to the user's calendar lists. (calendarList.insert)
   *
  ...
  /**
   * Returns entries on the user's calendar lists. (calendarList.listCalendarList)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string syncToken Token obtained from the nextSyncToken field
   ...
   * the previous lists request will always be in the result set and it is not
   ...
   * @opt_param bool showDeleted Whether to include deleted calendar lists entries
  ...
  public function listCalendarList($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Calendar_CalendarList");
  }

  /**
   * Updates an entry on the user's calendar lists. This method supports patch
  ...
  /**
   * Updates an entry on the user's calendar lists. (calendarList.update)
   *
   * @param string $calendarId Calendar identifier.
   * @param Google_CalendarListEntry $postBody
   * @param array $optParams Optional parameters.
...
class Google_Service_Calendar_Events_Resource extends Google_Service_Resource
{
   ...
   * returned on the last page of results from the previous lists request. It makes
   * the result of this lists request contain only entries that have changed since
   * then. All events deleted since the previous lists request will always be in
  ...
  public function listEvents($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Calendar_Events");
  }
...
class Google_Service_Calendar_Settings_Resource extends Google_Service_Resource
{
  ...
  public function listSettings($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Calendar_Settings");
  }
