...
class Google_Service_Tasks_Tasklists_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes the authenticated user's specified task lists. (tasklists.delete)
   *
   * @param string $tasklist Task lists identifier.
  ...
  /**
   * Returns the authenticated user's specified task lists. (tasklists.get)
   *
   * @param string $tasklist Task lists identifier.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Updates the authenticated user's specified task lists. This method supports
  ...
  /**
   * Updates the authenticated user's specified task lists. (tasklists.update)
   *
   * @param string $tasklist Task lists identifier.
   * @param Google_TaskList $postBody
   * @param array $optParams Optional parameters.
...
class Google_Service_Tasks_Tasks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Clears all completed tasks from the specified task lists. The affected tasks
   * will be marked as 'hidden' and no longer be returned by default when
   * retrieving all tasks for a task lists. (tasks.clear)
   *
   * @param string $tasklist Task lists identifier.
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Deletes the specified task from the task lists. (tasks.delete)
   *
   * @param string $tasklist Task lists identifier.
  ...
  /**
   * Creates a new task on the specified task lists. (tasks.insert)
   *
   * @param string $tasklist Task lists identifier.
  ...
  /**
   * Returns all tasks in the specified task lists. (tasks.listTasks)
   *
   * @param string $tasklist Task lists identifier.
   * @param array $optParams Optional parameters.
   *
  ...
  /**
   * Moves the specified task to another position in the task lists. This can
