...
class Google_Service_Drive_Apps_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string appFilterExtensions A comma-separated lists of file
   ...
   * @opt_param string appFilterMimeTypes A comma-separated lists of MIME types for
...
class Google_Service_Drive_Files_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string addParents Comma-separated lists of parent IDs to add.
   * @opt_param bool updateViewedDate Whether to update the view date after
   * successfully updating the file.
   * @opt_param string removeParents Comma-separated lists of parent IDs to remove.
