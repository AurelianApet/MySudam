...
class Google_Service_AdExchangeBuyer_Accounts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves the authenticated user's lists of accounts. (accounts.listAccounts)
   *
   * @param array $optParams Optional parameters.
  ...
  public function listAccounts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_AdExchangeBuyer_AccountsList");
  }
...
class Google_Service_AdExchangeBuyer_BillingInfo_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a lists of billing information for all accounts of the authenticated
  ...
  public function listBillingInfo($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_AdExchangeBuyer_BillingInfoList");
  }
}
...
class Google_Service_AdExchangeBuyer_Creatives_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a lists of the authenticated user's active creatives. A creative
  ...
  public function listCreatives($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_AdExchangeBuyer_CreativesList");
  }
}
...
class Google_Service_AdExchangeBuyer_DirectDeals_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves the authenticated user's lists of direct deals.
  ...
  public function listDirectDeals($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_AdExchangeBuyer_DirectDealsList");
  }
}
...
class Google_Service_AdExchangeBuyer_PerformanceReport_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves the authenticated user's lists of performance metrics.
  ...
  public function listPerformanceReport($accountId, $endDateTime, $startDateTime, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_AdExchangeBuyer_PerformanceReportList");
  }
}
...
class Google_Service_AdExchangeBuyer_PretargetingConfig_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a lists of the authenticated user's pretargeting configurations.
  ...
  public function listPretargetingConfig($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_AdExchangeBuyer_PretargetingConfigList");
  }
