...
class Google_Service_YouTubeAnalytics_BatchReports_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a lists of processed batch reports. (batchReports.listBatchReports)
   *
...
class Google_Service_YouTubeAnalytics_Reports_Resource extends Google_Service_Resource
{
   ...
   * @param string $metrics A comma-separated lists of YouTube Analytics metrics,
   * such as views or likes,dislikes. See the Available Reports document for a
   * lists of the reports that you can retrieve and the metrics available in each
   ...
   * @opt_param string dimensions A comma-separated lists of YouTube Analytics
   * dimensions, such as views or ageGroup,gender. See the Available Reports
   * document for a lists of the reports that you can retrieve and the dimensions
   ...
   * @opt_param string filters A lists of filters that should be applied when
