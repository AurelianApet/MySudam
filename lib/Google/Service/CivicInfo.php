...
class Google_Service_CivicInfo_Elections_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string electionId The unique ID of the election to look up. A lists
...
class Google_Service_CivicInfo_Representatives_Resource extends Google_Service_Resource
{
   ...
   * returned.
   * @opt_param string levels A lists of office levels to filter by. Only offices
   ...
   * @opt_param string roles A lists of office roles to filter by. Only offices
