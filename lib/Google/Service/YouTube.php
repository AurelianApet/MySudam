...
class Google_Service_YouTube_Activities_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of channel activity events that match the request criteria.
   ...
   *
   * @param string $part The part parameter specifies a comma-separated lists of
   ...
   * YouTube channel ID. The API will then return a lists of that channel's
   * activities.
  ...
  public function listActivities($part, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_ActivityListResponse");
  }
}
...
class Google_Service_YouTube_Captions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of caption tracks that are associated with a specified video.
   ...
   * @opt_param string debugProjectIdOverride The debugProjectIdOverride parameter
   * should be used for mimicking a request for a certain project ID.
   * @opt_param string id The id parameter specifies a comma-separated lists of IDs
  ...
  public function listCaptions($part, $videoId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_CaptionListResponse");
  }
...
class Google_Service_YouTube_ChannelSections_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string id The id parameter specifies a comma-separated lists of the
  ...
  public function listChannelSections($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_ChannelSectionListResponse");
  }
...
class Google_Service_YouTube_Channels_Resource extends Google_Service_Resource
{
   ...
   * a lists of channels that subscribed to the authenticated user's channel.
  ...
  public function listChannels($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_ChannelListResponse");
  }
...
class Google_Service_YouTube_CommentThreads_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of comment threads that match the API request parameters.
   ...
   * in plain text.
   * @opt_param string id The id parameter specifies a comma-separated lists of
  ...
  public function listCommentThreads($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_CommentThreadListResponse");
  }
...
class Google_Service_YouTube_Comments_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of comments that match the API request parameters.
  ...
  public function listComments($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_CommentListResponse");
  }

  /**
   * Expresses the caller's opinion that a comment is spam. (comments.markAsSpam)
   *
   * @param string $id The id parameter specifies a comma-separated lists of IDs of
   ...
   * author of the comment to the ban lists. This means all future comments of the
...
class Google_Service_YouTube_GuideCategories_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of categories that can be associated with YouTube channels.
   ...
   *
   * @opt_param string regionCode The regionCode parameter instructs the API to
   * return the lists of guide categories available in the specified country. The
  ...
  public function listGuideCategories($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_GuideCategoryListResponse");
  }
}
...
class Google_Service_YouTube_I18nLanguages_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of supported languages. (i18nLanguages.listI18nLanguages)
   *
   * @param string $part The part parameter specifies a comma-separated lists of
  ...
  public function listI18nLanguages($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_I18nLanguageListResponse");
  }
}
...
class Google_Service_YouTube_I18nRegions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of supported regions. (i18nRegions.listI18nRegions)
   *
   * @param string $part The part parameter specifies a comma-separated lists of
  ...
  public function listI18nRegions($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_I18nRegionListResponse");
  }
}
...
class Google_Service_YouTube_LiveBroadcasts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of YouTube broadcasts that match the API request parameters.
  ...
  public function listLiveBroadcasts($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_LiveBroadcastListResponse");
  }
...
class Google_Service_YouTube_LiveStreams_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of video streams that match the API request parameters.
  ...
  public function listLiveStreams($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_LiveStreamListResponse");
  }
...
class Google_Service_YouTube_PlaylistItems_Resource extends Google_Service_Resource
{
   ...
   * nextPageToken and prevPageToken properties identify other pages that could be
   * retrieved.
   * @opt_param string id The id parameter specifies a comma-separated lists of one
  ...
  public function listPlaylistItems($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_PlaylistItemListResponse");
  }
...
class Google_Service_YouTube_Playlists_Resource extends Google_Service_Resource
{
  ...
  public function listPlaylists($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_PlaylistListResponse");
  }
...
class Google_Service_YouTube_Search_Resource extends Google_Service_Resource
{
   ...
   * retrieve a particular type of resource. The value is a comma-separated lists
   * of resource types.
   ...
   * lists of videos that are related to the video that the parameter value
  ...
  public function listSearch($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_SearchListResponse");
  }
}
...
class Google_Service_YouTube_Subscriptions_Resource extends Google_Service_Resource
{
   ...
   * separated lists of channel IDs. The API response will then only contain
  ...
  public function listSubscriptions($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_SubscriptionListResponse");
  }
}
...
class Google_Service_YouTube_VideoAbuseReportReasons_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of abuse reasons that can be used for reporting abusive
  ...
  public function listVideoAbuseReportReasons($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_VideoAbuseReportReasonListResponse");
  }
}
...
class Google_Service_YouTube_VideoCategories_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a lists of categories that can be associated with YouTube videos.
   ...
   *
   * @opt_param string regionCode The regionCode parameter instructs the API to
   * return the lists of video categories available in the specified country. The
   * parameter value is an ISO 3166-1 alpha-2 country code.
   * @opt_param string id The id parameter specifies a comma-separated lists of
  ...
  public function listVideoCategories($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_VideoCategoryListResponse");
  }
}
...
class Google_Service_YouTube_Videos_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves the ratings that the authorized user gave to a lists of specified
   * videos. (videos.getRating)
   *
   * @param string $id The id parameter specifies a comma-separated lists of the
  ...
  /**
   * Returns a lists of videos that match the API request parameters.
   * (videos.listVideos)
   *
   * @param string $part The part parameter specifies a comma-separated lists of
  ...
  public function listVideos($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_YouTube_VideoListResponse");
  }
