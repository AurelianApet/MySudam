...
{
  /** Manage the lists of sites and domains you control. */
...
class Google_Service_SiteVerification_WebResource_Resource extends Google_Service_Resource
{
  ...
  /**
   * Get the lists of your verified websites and domains.
  ...
  public function listWebResource($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_SiteVerification_SiteVerificationWebResourceListResponse");
  }

  /**
   * Modify the lists of owners for your website or domain. This method supports
  ...
  /**
   * Modify the lists of owners for your website or domain. (webResource.update)
   *
   * @param string $id The id of a verified site or domain.
   * @param Google_SiteVerificationWebResourceResource $postBody
   * @param array $optParams Optional parameters.
