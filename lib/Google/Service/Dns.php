...
class Google_Service_Dns_Changes_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string pageToken Optional. A tag returned by a previous lists
   * request that was truncated. Use this parameter to continue a previous lists
   * request.
...
class Google_Service_Dns_ResourceRecordSets_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string name Restricts the lists to return only records with this
   ...
   * request that was truncated. Use this parameter to continue a previous lists
   * request.
   * @opt_param string type Restricts the lists to return only records of this
