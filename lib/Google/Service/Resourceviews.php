...
class Google_Service_Resourceviews_ZoneOperations_Resource extends Google_Service_Resource
{
  ...
  public function listZoneOperations($project, $zone, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Resourceviews_OperationList");
  }
}
...
class Google_Service_Resourceviews_ZoneViews_Resource extends Google_Service_Resource
{
   ...
   * lists request. This token can be used to request the next page of results from
   * a previous lists request.
  ...
  public function listZoneViews($project, $zone, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Resourceviews_ZoneViewsList");
  }
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string listState The state of the instance to lists. By default, it
   * lists all instances.
