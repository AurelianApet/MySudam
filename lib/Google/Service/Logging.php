...
class Google_Service_Logging_ProjectsLogs_Resource extends Google_Service_Resource
{
   ...
   * continued.
   * @opt_param string serviceName A service name for which to lists logs. Only
   ...
   * log names are returned. To lists all log names, regardless of service, leave
   * both the `serviceName` and `serviceIndexPrefix` empty. To lists log names
   ...
   * lists logs. Only logs containing entries whose metadata that includes these
   * label values (associated with index keys) are returned. The prefix is a slash
   * separated lists of values, and need not specify all index labels. An empty
