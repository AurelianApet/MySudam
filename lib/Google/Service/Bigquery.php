...
class Google_Service_Bigquery_Datasets_Resource extends Google_Service_Resource
{
   ...
   * @opt_param bool all Whether to lists all datasets, including hidden ones
  ...
  public function listDatasets($projectId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Bigquery_DatasetList");
  }
...
class Google_Service_Bigquery_Jobs_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists all jobs that you started in the specified project. The job lists
   ...
   * (jobs.listJobs)
   *
   * @param string $projectId Project ID of the jobs to lists
   * @param array $optParams Optional parameters.
   *
  ...
  public function listJobs($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Bigquery_JobList");
  }
...
class Google_Service_Bigquery_Projects_Resource extends Google_Service_Resource
{
  ...
  public function listProjects($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Bigquery_ProjectList");
  }
}
...
class Google_Service_Bigquery_Tabledata_Resource extends Google_Service_Resource
{
  ...
  public function listTabledata($projectId, $datasetId, $tableId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Bigquery_TableDataList");
  }
}
...
class Google_Service_Bigquery_Tables_Resource extends Google_Service_Resource
{
   ...
   * (tables.listTables)
   *
   * @param string $projectId Project ID of the tables to lists
   * @param string $datasetId Dataset ID of the tables to lists
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken Page token, returned by a previous call, to
   * request the next page of results
  ...
  public function listTables($projectId, $datasetId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('lists', array($params), "Google_Service_Bigquery_TableList");
  }
